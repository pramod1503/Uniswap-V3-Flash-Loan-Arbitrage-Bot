...
contract FlashLoanArbTest is Test {
    ...
    function setUp() public {
        ...
        calculatedPoolAddress = _computePoolAddress(factory, address(usdc), address(weth), 3000);
    ...
    function _computePoolAddress(address _factory, address _token0, address _token1, uint24 _fee)
        internal
        pure
